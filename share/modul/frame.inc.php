...
function modulFrame($config, $p_modulSelect, $p_modulAction, $viewItem)
	{
	$layoutNoContent = explode(",",$config['configShare']['layoutNoContent']);
	if (in_array($config['modulSelect'],$layoutNoContent)) {
		$config["layoutMainHTML"]="layoutnocontent";
	}
		...
		switch ($config["modulAction"])
			...
			case "list":
				...
				if (!isset($_REQUEST['listVSChart']) || (isset($_REQUEST['listVSChart']) && $_REQUEST['listVSChart']=="List")) {
					$config[$config["modulSelect"]]["viewDescription"]=0;
					$config[$config["modulSelect"]]["viewmedicine_topicDescription"]=0;
					$_SESSION[$config["modulSelect"]]["description"]=1;
					...
					$config[$config["modulSelect"]."_x_description_enable"]=0;
					$config[$config["modulSelect"]."_x__medicine_topicDescription_enable"]=0;
			
				} else if (isset($_REQUEST['listVSChart']) && $_REQUEST['listVSChart']=="Full") {
					$config[$config["modulSelect"]]["viewDescription"]=1;
					$config[$config["modulSelect"]]["viewmedicine_topicDescription"]=1;
					$_SESSION[$config["modulSelect"]]["description"]=0;
					...
					$config[$config["modulSelect"]."_x__medicine_topicDescription_enable"]=1;
				}
			...
			case "view":
				...
				$config[$config['modulSelect']]['readonly']='readonly="readonly"';
				$config[$config['modulSelect']]['disabled']='disabled="disabled"';
			...
			case "add":
				...
				$config[$config["modulSelect"]]["whichCheck"]="checkCFG";
				$config[$config["modulSelect"]]["whichPosition"]="positionCFG";
				$config[$config['modulSelect']]['readonly']='';
				$config[$config['modulSelect']]['disabled']='';
